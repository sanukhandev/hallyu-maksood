                    ...
                    <div class="row">
                      ...
                      <div class="col-10">
                        <div class="price-container">
                          ...
                          <input type="text" class="input-field price-input" id="${data[i].attribute.input_name}${data[i].options[j].id}_price" data-name="${data[i].attribute.input_name}_price[]" placeholder="${lang.additional_price}" value="">
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-lg-7 ${priceClass}">
                      <div class="row">
                        ...
                        <div class="col-10">
                          <div class="price-container">
                            <span class="price-curr">${curr.sign}</span>
                            <input type="text" id="${data[i].attribute.input_name}${data[i].options[j].id}_price" class="input-field price-input" data-name="${data[i].attribute.input_name}_price[]" placeholder="${lang.additional_price}" value="">
                          </div>
                        </div>
                      </div>
                    </div>
