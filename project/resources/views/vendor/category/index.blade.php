							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('vendor-cat-index') }}">{{ __('Main Categories') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
(function($) {
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('vendor-cat-datatables') }}',
               columns: [
                        { data: 'name', name: 'name' },
						{ data: 'slug', name: 'slug' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('vendor-cat-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
