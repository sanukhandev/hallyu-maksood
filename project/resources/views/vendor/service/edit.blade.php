          ...
          <div class="body-area">
            ...
            <form id="geniusformdata" action="{{route('vendor-service-update',$data->id)}}" method="POST"
                ...
                <div class="col-lg-7">
                  <div class="img-upload">
                    <div id="image-preview" class="img-preview"
                      style="background: url({{ $data->photo ? asset('assets/images/services/'.$data->photo):asset('assets/images/noimage.png') }});">
              ...
              <div class="row">
                ...
                <div class="col-lg-7">
                  <textarea class="input-field" name="details"
                    placeholder="{{ __('Description') }}">{{ $data->details }}</textarea>
                </div>
              </div>
