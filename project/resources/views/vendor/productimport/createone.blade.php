...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
					<h4 class="heading">{{ __("Affiliate Product") }} <a class="add-btn" href="{{ route('vendor-import-index') }}"><i class="fas fa-arrow-left"></i> {{ __("Back") }}</a></h4>
					<ul class="links">
						<li>
							...
							<div class="body-area">
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<ul class="list">
											<li>
												<input name="size_check" class="stock-check" type="checkbox" id="size-check" value="1">
