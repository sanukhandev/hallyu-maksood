...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"> {{ __('Physical Product') }} <a class="add-btn" href="{{ url()->previous() }}"><i
				...
				<ul class="links">
					...
					<li>
						<a href="javascript:;">{{ __('Product Catalogs') }}</a>
					</li>
					<li>
						<a href="{{ route('vendor-prod-catalog-edit',$data->id) }}">{{ __('Physical Product') }}</a>
					</li>
				</ul>
			</div>
		</div>
						...
						<div class="col-lg-12">
											...
											<div class="col-lg-5">
												<div class="custom-control custom-checkbox">
													...
													@if(is_array($selectedAttrs) &&
														array_key_exists($catAttribute->input_name,$selectedAttrs))
											...
											<div class="col-lg-5">
												<div class="custom-control custom-checkbox">
													<input type="checkbox"
														...
														class="custom-control-input attr-checkbox" 
														@if(is_array($selectedAttrs) &&
														array_key_exists($subAttribute->input_name,$selectedAttrs))
													@php
													$inName = $subAttribute->input_name;
													@endphp
													@if (is_array($selectedAttrs["$inName"]["values"]) &&
											...
											<div class="col-lg-5">
												<div class="custom-control custom-checkbox">
													<input type="checkbox"
														...
														class="custom-control-input attr-checkbox" 
													@if(is_array($selectedAttrs) &&
														array_key_exists($childAttribute->input_name,$selectedAttrs))
													@php
													$inName = $childAttribute->input_name;
													@endphp
													@if (is_array($selectedAttrs["$inName"]["values"]) &&
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<select name="preordered">
											<option value="1" {{$data->product_condition == 1 ? "selected":""}}>{{ __('Sale') }}</option>
											<option value="2" {{$data->product_condition == 2 ? "selected":""}}>{{ __('Preordered') }}</option>
										</select>
									</div>
								</div>
							</div>
												...
												@foreach(array_unique($data->color) as $ct)
													<div class="color-area">
														...
														<div class="input-group colorpicker-component cp">
															<input type="text" value="{{ $ct }}"  class="input-field cp tcolor"/>
										...
										<div  class="col-lg-12">
												<div class="select-input-tsize" id="tsize-section">
													...
													<div class="tsize-area">
														...
														<input  type="text" class="input-field tsize" placeholder="{{ __('Enter Product Size') }}" value="{{ $dt }}"  required="" >
													 </div>
													@endforeach
												</div>
													...
													<div class="row">
														<div class="col-lg-6">
															<input type="number" name="whole_sell_qty[]"
																...
																value="{{ $data->whole_sell_qty[$key] }}" required="">
														</div>
														...
														<div class="col-lg-6">
															<input type="number" name="whole_sell_discount[]"
																...
																min="0" value="{{ $data->whole_sell_discount[$key] }}"
																required="">
														</div>
													</div>
												</div>
							...
							<div class="row">
								...
								<div class="col-lg-12">
									<ul class="list">
										<li>
											<input name="size_check" class="stock-check" type="checkbox" id="size-check" value="1" {{ !empty($data->size) ? "checked":"" }}>
