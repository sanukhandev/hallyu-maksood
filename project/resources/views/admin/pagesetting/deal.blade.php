...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Edit Deal Of The Day') }} <a class="add-btn" href="{{route('admin-gs-deal')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                      ...
                      @include('alerts.admin.form-both')
                                      {{-- Sub Title Section --}}
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" name="deal_title" value="{{ $gs->deal_title }}" placeholder="Add title here">
                                                </div>
                                              </div>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="deal_details" value="{{ $gs->deal_details }}" placeholder="Add details here">
                                              </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="deal_time" value="{{ $gs->deal_time }}" placeholder="Add Date here">
                                              </div>
                                            </div>
