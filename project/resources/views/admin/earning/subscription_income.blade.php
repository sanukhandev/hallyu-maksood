...
@section('content')  
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Subscription Eairning') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('admin-subscription-income') }}">{{ __('Subscription Eairning') }}</a>
											</li>
										</ul>
								</div>
							</div>
						</div>
						<form action="{{route('admin-subscription-income')}}" method="GET">
...
<script type="text/javascript">
	...
	$('.discount_date').val('');
	location.href = '{{route('admin-subscription-income')}}';
	})												
</script>
@endsection   