            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin-brand-index') }}">{{ __("All Brands") }}</a>
                        </li>
                        <li>
                            <a href="{{ route('admin-brand-create') }}">{{ __("Create Brands") }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        </div>
        <form id="geniusform" action="{{route('admin-brand-store')}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
