                                    ...
                                    <div class="body-area">
                                            ...
                                            <div class="col-lg-12">
                                                <select name="language_id" required="">
                                                    @foreach(DB::table('languages')->get() as $ldata)
                                                        <option
                                                            value="{{ $ldata->id }}" {{ $ldata->id == $data->language_id ? 'selected' : '' }}>{{ $ldata->language }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                <ul class="list">
                                                    <li>
                                                        <input class="checkclick1" name="product_condition_check"
                                                               type="checkbox" id="conditionCheck"
                                                ...
                                                <ul class="list">
                                                    <li>
                                                        <input class="checkclick1" name="preordered_check"
                                                               type="checkbox" id="preorderedCheck"
                                                               value="1" {{ $data->preordered != 0 ? "checked":"" }}>
                                                        <label
                                                ...
                                                <ul class="list">
                                                    <li>
                                                        <input class="checkclick1" name="minimum_qty_check"
                                                               type="checkbox" id="check111"
                                                               value="1" {{$data->minimum_qty != null ? "checked":""}}>
                                                        <label
                                                            for="check111">{{ __('Allow Minimum Order Qty') }}</label>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <input type="number" class="input-field" min="1"
                                                           placeholder="{{ __('Minimum Order Qty') }}"
                                                           name="minimum_qty"
                                                ...
                                                <ul class="list">
                                                    <li>
                                                        <input class="checkclickc" name="color_check" type="checkbox"
                                                               id="check3"
                                                               value="1" {{ !empty($data->color_all) ? "checked":"" }}>
                                                ...
                                                <ul class="list">
                                                    <li>
                                                        <input class="checkclicks" name="size_check" type="checkbox"
                                                               id="tcheck"
                                                               value="1" {{ !empty($data->size_all) ? "checked":"" }}>
                                        ...
                                        <div class="{{ $data->measure == null ? 'showbox' : '' }}">
                                            <div class="row">
                                                ...
                                                <div
                                                    class="col-lg-6 {{ in_array($data->measure,explode(',', 'Gram,Kilogram,Litre,Pound')) ? 'hidden' : '' }}"
                                                    id="measure">
                                                                        ...
                                                                        <div class="col-md-3 col-sm-6">
                                                                            ...
                                                                            <select name="size[]"
                                                                                ...
                                                                                @foreach($data->size as $dt)
                                                                                    <option
                                                                                        value="{{ $dt }}" {{ $dt == $data1 ? 'selected' : '' }}>{{ $dt }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-md-3 col-sm-6">
                                                                        ...
                                                                        <div class="col-md-3 col-sm-6">
                                                                            ...
                                                                            <select name="color[]"
                                                                                ...
                                                                                @foreach($data->color as $ct)
                                                                                    <option value="{{ $ct }}"
                                                                                            style="background-color:{{ $ct }}" {{ $ct == $data->color[$key] ? 'selected' : '' }}></option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="text-editor">
                                                    <textarea name="details"
                                                              class="nic-edit-p">{{$data->details}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="text-editor">
                                                    <textarea name="policy"
                                                              class="nic-edit-p">{{$data->policy}}</textarea>
                                                </div>
                                            </div>
                                        </div>
