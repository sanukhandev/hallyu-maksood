												...
												<div class="row">
													...
													<div class="{{ $data->is_discount == 0 ? "showbox":"" }}">
														...
														<div class="row">
															...
															<div class="col-sm-8">
																<input type="text" class="input-field" name="discount_date"  placeholder="{{ __("Enter Date") }}" autocomplete="off" id="discount_date" value="{{ $data->discount_date }}">
													...
													<div class="row">
														...
														<div class="row">
															<div class="col-lg-8">
																<div class="left-area">
																	<h4 class="heading">{{ __("Highlight in") }} {{ __('Best Selling') }} *</h4>
																</div>
															</div>
															  <div class="col-sm-3">
																<label class="switch">
